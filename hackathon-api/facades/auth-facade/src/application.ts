...
export class AuthFacadeApplication extends BootMixin(
  ...
  constructor(options: ApplicationConfig = {}) {
    ...
    this.component(FileUploaderComponent);
    ...
    this.bind(AWSS3Bindings.Config).to({
      ...
      s3ForcePathStyle: process.env.AWS_S3FORCEPATH, // needed with minio?
    } as AwsS3Config);
